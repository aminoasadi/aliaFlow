...
const sections: Record<string, Record<string, unknown>> = {
  ...
  "thrivable-business": {
    ...
    futures: [
      { image: "/assets/future-of-banking-card.png", title: "Future of Banking in a Technocratic World", heading: "Future of Banking", label: "Industry Name", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("future-of-banking", "Banking is being rebuilt around technologies that did not exist when its current operating model was designed.") },
      { image: "/assets/future-of-banking-card.png", title: "Future of Governance in a Technocratic World", heading: "Future of Governance", label: "Industry Name", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("future-of-governance", "Governance is slow by design, and the systems it governs are no longer slow.") },
      { image: "/assets/future-of-banking-card.png", title: "Future of Education in a Technocratic World", heading: "Future of Education", label: "Industry Name", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("future-of-education", "Education is being pulled apart by the same forces that are rebuilding the work it prepares people for.") },
    ],
    loops: [
      { image: "/assets/aliasys-loop.png", title: "Aliasys business loop", heading: "Aliasys Business Loop", label: "ICT Infrastructure", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("aliasys-business-loop", "An ICT infrastructure business whose growth depended on making its own complexity invisible.") },
      { image: "/assets/aliapay-loop.png", title: "Aliapay business loop", heading: "Aliapay Business Loop", label: "Banking and Fintech", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("aliapay-business-loop", "A payments business that had to earn loyalty in a market where switching costs had collapsed.") },
      { image: "/assets/alialab-loop.png", title: "AliaLab business loop", heading: "AliaLab Business Loop", label: "Education", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("alialab-business-loop", "An education lab that treated every cohort as a test of its own operating model.") },
    ],
    cultures: [
      { image: "/assets/workshop.png", title: "Technocratic culture workshop", heading: "Technocratic Culture", label: "ICT Infrastructure", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("technocratic-culture", "A culture where technical judgement carries the same weight as commercial judgement.") },
      { image: "/assets/design-event.png", title: "Design thinking workshop", heading: "Design Thinking Culture", label: "Innovation & Design", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("design-thinking-culture", "A culture that starts every problem in the room where the problem is felt.") },
      { image: "/assets/meeting-halftone.png", title: "Collaborative agile culture meeting", heading: "Collaborative Agile Culture", label: "Leadership & Management", body: "Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet, consevbi adis Dolor sit amet, consevbi adis elit, sed do eismod tempdl sit amet.", ...article("collaborative-agile-culture", "A culture that moves in short cycles without losing the thread between them.") },
    ],
